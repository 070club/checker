...
if __name__ == '__main__':
    ...
    scores = None
    if args.year == '2020':
        valid_entries, invalid_entries, scores = contests.tdw_2020(adif_files, summary[args.call.upper()])
    else:
    ...
    if args.score_only:
        ...
        if valid_entries:
            contests.print_entries_tdw(valid_entries, valid=True)
        if not args.valid_only:
            if invalid_entries:
                contests.print_entries_tdw(invalid_entries, valid=False)
