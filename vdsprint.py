...
if __name__ == '__main__':
    ...
    if args.year == '2019':
        valid_entries, invalid_entries, scores = contests.vdsprint_2019(adif_files, summary[args.call.upper()])
    elif args.year == '2020':
        valid_entries, invalid_entries, scores = contests.vdsprint_2020(adif_files, summary[args.call.upper()])
    else:
